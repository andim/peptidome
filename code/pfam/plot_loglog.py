...
fig, ax = plt.subplots(figsize=(2.0, 2.25))
df = pd.read_csv('data/mutualinformation_nozf.csv')
ax.plot(df['gaps']+1, df['mutualinformation'], 'o', ms=1.0, label='Human Proteome')
...
fig.savefig(figuredir+'mutualinformationdecay.svg')
plt.show()
