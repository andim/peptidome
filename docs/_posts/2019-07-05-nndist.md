...
![png](notebook_files/nn_analysis_15_0.png)
...
```
    ...
    <ipython-input-28-1786c2b0696f> in <module>
          8     print(name)
          9     ax = axes[i]
    ---> 10     d = df_t[mask]
         11     d0 = d['Epitope', 'Description'].apply(lambda x: x in human9)
         12     count0 = np.sum(d0)
    ...
    ~/.conda/envs/py3/lib/python3.6/site-packages/pandas/core/frame.py in _getitem_bool_array(self, key)
    ...
    ~/.conda/envs/py3/lib/python3.6/site-packages/pandas/core/indexing.py in check_bool_indexer(ax, key)
...
![png](notebook_files/nn_analysis_29_3.png)
...
![png](notebook_files/nn_analysis_31_0.png)
